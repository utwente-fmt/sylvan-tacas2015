...
def prepare_experiments():
    ...
    for w in workers:
        for o in orders:
            for m in models:
                experiments.append((m, o, ("dve2lts-sym","--when","--vset=sylvan","-rgs","--sylvan-tablesize=30","--sylvan-cachesize=30","--order={}".format(o),"--lace-workers={}".format(w),"models/{}.dve".format(m)), int(w)))
